...
<div class="display-style-1">
    <div class="flex">
        ...
        ?>
                ...
                <p class="simple">Please enter the username of a user to invite below for your team <span style="font-size:90%;opacity:0.66">(Press enter to send request)</span></p>
        ...
        ?>
                ...
                <div class="form-field">
                    <label class="nightmare">Team Name</label>
