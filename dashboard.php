...
.profile-details{margin:25px 0;font-family: serif;}.profile-about a{border:1px solid var(--text-color);padding:8px 12px;line-height:40px}.profile-about a:hover{border-color:var(--highlight-color);}
...
p.simple{font-size:1.2rem;line-height:1.4rem;margin:0;}
    ...
    <div class="flex">
        ...
        if($user['verified'] == 0){?>
            <div class="verification-box" style="margin-top:0">
                <h3 class="nightmare">Verify your account now</h3>
                <p class="simple sangkury">You need to verify your account to be able to participate in Culrav 2021.<br/><br/>Please enter your &nbsp;<strong><u>registration number</u></strong>&nbsp; to verify.</p>
                <p class="simple sangkury"><span id="verification-message">Verification Code Sent</span></p>
        ...
        ?>
            <div class="participate">
                <h3 class="nightmare">Participate</h3>
                <p class="simple sangkury">You need to register for your events before participating in them. Here you can choose your event and participate in them along with the given time constraint.</p><br/>
        ...
        if(!$misc->checkIfUserPaid($user['username'])){?>
            <div class="payment-box">
                <h3 class="nightmare">Pay your fees</h3>
                <p class="simple sangkury">You will be charged a fee of ₹1500 for participating in Culrav.</p>
                <p class="simple sangkury">This fees are for participating in Culrav and includes accomodation and pronite charges.</p>
        ...
        ?>
            <div id="team-request-<?php echo $request['teamID']?>" class="team-request">
                <h3 class="nightmare">Team Event Request</h3>
                <p class="simple sangkury"><span class="user"><?php $requestBy = $misc->getUser($request['requestBy']);echo $requestBy['name']?></span> requests you to join their team <a class="team-name"><?php echo $misc->getTeamNameByTeamID($request['teamID']);?></a> for the event <a><?php echo $misc->getEventNameByEventID($request['eventID']);?></a></p>
                <div class="choice" data-requestID="<?php echo $request['requestID'];?>"><button data-team-id="<?php echo $request['teamID'];?>" class="submit-button accept-button" style="border-color:green;color:green"><i class="fa fa-check"></i>Yes</button><button data-team-id="<?php echo $request['teamID'];?>"  class="submit-button reject-button" style="border-color:#ff5c5c;color:#ff5c5c"><i class="fa fa-times"></i>No</button></div>
        ...
        ?>
            <div class="select-event-to-register">
                <h3 class="nightmare">Select individual events to register</h3>
		<p class="simple sangkury">These events carry points and will be directly alloted and affect your overall performance score.</p>
		<p class="simple sangkury">There might be some issues with Mr. and Ms. Spandan event and Maskhare Event. We are working to resolve this at the earliest.</p>
        ...
        ?>
            ...
            <div class="select-team-event-to-register">
                <h3 class="nightmare">Register for team events</h3>
                <p class="simple sangkury">Create a team of members and participate in the most enticing events of Culrav 2021. Make new connections and compete against other teams.</p>
            ...
            <div class="select-event-to-deregister">
                <h3 class="nightmare" style="color:#ff5c5c">Deregister from events</h3>
                <p class="simple sangkury" style="color:#ff5c5c;opacity:0.66;">It does not matter how slowly you go as long as you do not stop.</p>
                <div class="option-list">
                    <select name="event-to-deregister" style="border-color:#ff5c5c;color:#ff5c5c;">
                        <option selected disabled value>--Select an option--</option>
        <?php
        ...
        ?>
                ...
                <button id="individual-event-deregister" class="submit-button" style="border-color:#ff5c5c;color:#ff5c5c;">Deregister</button>
                </div>
            </div>
        <?php
        }
        ...
        <div>
            <h3 class="nightmare">End Registration Period</h3>
            <p class="simple sangkury">End the registration period and hence no student can register for this event any more. It will also trigger the start of the rounds so be careful when you choose to end your registration period.</p><br>
        ...
        <div id="choose-round-system">
            <h3 class="nightmare">Select Round System</h3>
            <p class="simple sangkury">If you want to apply a rounds system for your event.</p><br>
            ...
            <button class="submit-button" style="color:#ff5c5c;border-color:#ff5c5c;display:inline-block;margin-left:20px;" onclick="javascript:window.location.href='toggleEvent?action=removeRoundSystem&eventID=<?php echo $event['eventID'];?>';"><i class="fa fa-times" style="margin-right:8px"></i>No</button>
        </div>
        <?php }
        }
        else{ ?>
        <div>
            <h3 class="nightmare">Resume Registration Period</h3>
            <p class="simple sangkury">Resume the registration period and hence students can register for this event.</p><br>
        ...
        <div>
            <h3 class="nightmare">Delcare the end of event</h3>
            <p class="simple sangkury">Declare that the events have ended and the results will be announced.</p><br>
        ...
        <?php 
            if($event['rounds'] == 1){ ?>
                <div id="round-system">
                    <h3 class="nightmare">Round System</h3>
                    <p class="simple sangkury">Make changes to your number of rounds and it's timings, </p><br>
        ...
        <div>
            <h3 class="nightmare">The Event Has Ended</h3>
            <p class="simple sangkury">Congratulations! The event has ended and please wait for the coordinators to update the results.</p>
        </div>
        <div>
            <h3 class="nightmare">Allot Points</h3>
            <p class="simple sangkury">The points that each participant/team got on this event, they will all be put into consideration for all final deciding score.</p>
        ...
        <div>
            <h3 class="nightmare">The Event Has Been Cancelled</h3>
            <p class="simple sangkury">Due to some reasons, the team decided to drop the event. Sorry for the inconvinience.</p>
        </div>
        <?php }
        if(($event['registrationStatus'] == 0 || $event['registrationStatus'] == 1) and $event['rounds'] != 1){ ?>
            <div>
                <h3 class="nightmare">Submissions</h3>
                <p class="simple sangkury">You can check out all the submission links for your event over here. The submissions are sorted according to the time of submission.</p><br/>
                <?php
                ...
                if(count($links) == 0){
                ?>
                    <p class="simple sangkury">There are no submissions yet!</p>
                <?php
                }
                ?>
            </div>
        ...
        <?php } ?>
            <div>
                <h3 class="nightmare">Get the <?php echo $event['eventtype'].'s'; ?> list</h3>
                <p class="simple sangkury">Get the list of teams/individuals participating in the event that you're responsible for.</p><br>
                <?php
                if($event['eventtype'] == 'team'){
                    $teams = $misc->getTeamsByEventID($event['eventID']);
                ?>
                ...
                <?php
                    if(count($teams) == 0){ ?>
                        <p class="simple sangkury">Please wait for the students to register for your event!</p>
                <?php
                    }
                }
                else if($event['eventtype'] == 'individual'){
                ...
                <?php
                    if(count($participants) == 0){ ?>
                        <p class="simple sangkury">Sorry, no one registered for your event!</p>
                <?php
                    }
                }
                ?>
        ...
        ?>
            <div style="overflow-x:auto;">
                <h3 class="nightmare">Top Point List</h3>
                <p class="simple sangkury">The list of top 10 students competing.</p>
            ...
            <div>
                <h3 class="nightmare">Get Paid Students List</h3>
                <p class="simple sangkury">Print the list of all the registered students who paid.</p>
                <button class="submit-button" onclick="javascript:printPaidList()" style="margin-top:10px">Print</button>
            </div>
            <div>
                <h3 class="nightmare">Get Co-ordinator List</h3>
                <p class="simple sangkury">Print the list of all the co-ordinators.</p>
                <button class="submit-button" onclick="javascript:printCoordinatorList()" style="margin-top:10px">Print</button>
            </div>
            <div>
                <h3 class="nightmare">Register Co-ordinator</h3>
                <p class="simple sangkury">Register a co-ordinator only after verifying the details about them.</p>
            ...
            <div>
                <h3 style="color:#ff5c5c">Disqualify Student</h3>
                <p class="simple sangkury" style="color:#ff5c5c;opacity:0.66;">Disqualify a student due to some specific reason.</p>
                <select name="student-to-disqualify" style="border-color:#ff5c5c;color:#ff5c5c;">
                    <option selected disabled value>--Select an option--</option>
                </select>
                <button id="student-to-disqualify-button" class="submit-button" style="border-color:#ff5c5c;color:#ff5c5c;">Disqualify</button>
            </div>
        <?php
        }
        ?>
        ...
        <div class="container-left">
            <div class="profile-about">
                ...
                <div class="profile-details">
                    <h3 class="curseOfZombie"><?php echo $user['name'];?></h3>
                    <p><?php echo $user['college'];?></p>
                <?php 
                if($user['usertype'] == 'students'){
                    if($user['verified'] == 0){?>
                        <p class="simple sangkury">Your account isn't verified yet.</p>
                    <?php
                    }
                    else{ ?>
                        <p class="simple sangkury">Welcome to Culrav 2022</p>
                ...
                ?>
                    <p class="simple sangkury">You're a Coordinator</p>
                    <p class="simple sangkury">Your Event: <?php echo $event['event_name']; ?></p>
                <?php
                }
                else if($user['usertype'] == 'admin'){
                ?>
                    <p class="simple sangkury">You're the superior authority.</p>
                    <p class="simple sangkury">Have a great day!</p>
                <?php
                }?>
                </div>
            ...
            ?>
                <div class="events-in-action">
                    <h3 class="nightmare">Events Registered</h3>
                <?php
            ...
            ?>
                <div class="profile-about">
                    <div class="profile-details" style="margin-top:0;">
                        <h3 class="nightmare">Total Events Conducting</h3>
                    </div>
                        <h3 class="nightmare"><?php echo $misc->getTotalEventsCount();?></h3>
                </div>
                <div class="profile-about">
                    <div class="profile-details" style="margin-top:0;">
                        <h3 class="nightmare">Total Students Registered</h3>
                    </div>
                        <h3 class="nightmare"><?php echo $misc->getTotalStudentsRegisteredCount();?></h3>
                </div>
                <div class="profile-about">
                    <div class="profile-details" style="margin-top:0;">
                        <h3 class="nightmare">Total Students Paid Fees</h3>
                    </div>
                        <h3 class="nightmare"><?php echo $misc->getTotalStudentsPaidFeesCount();?></h3>
                </div>
            <?php
            }
            else if($user['usertype'] == 'coordinator'){
                ?>
                    <div class="profile-about">
                        <div class="profile-details" style="margin-top:0;">
                            <h3 class="nightmare">Total <?php echo $event['eventtype'].'s'; ?></h3>
                        </div>
                            <h3 class="nightmare"><?php echo $misc->getParticipantOrTeamCountInEvent($event['eventID'],$event['eventtype']);?></h3>
                    </div>
                    <div class="profile-about">
                        <div class="profile-details" style="margin-top:0;">
                            <h3 class="nightmare">Total Submissions</h3>
                        </div>
                            <h3 class="nightmare"><?php $data = $misc->getSubmissionLinksForCoordinatorsByEventID($user['username'],$event['eventID']); echo count($data['data']); ?></h3>
                    </div>
                <?php
                }
            ?>
...
$('#verification-button').on('click',function(){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            else{$('#verification-message').css("color","#ff5c5c");}
        },
        error:function(error){
            $('#verification-message').html("Not Connected to the Internet");
            $('#verification-message').css('display','block');
            $('#verification-message').css("color","#ff5c5c");
        }
    });
});
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data.status == true){
                ...
                $('.events-in-action div:contains(None yet)').remove();
            ...
            else{$('#individual-event-to-register-message').css("color","#ff5c5c"); if(data['logout']) loaction.reload(); }
        },
        error:function(error){
            $('#individual-event-to-register-message').html("Not Connected to the Internet");
            $('#individual-event-to-register-message').css('display','block');
            $('#individual-event-to-register-message').css("color","#ff5c5c");
        }
    });
});
$('#individual-event-deregister').on('click',function(){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data.status == true){
                ...
                if(data.eventtype == "individual"){
                    ...
                    if($('.events-in-action div').length == 0)
                        $('.events-in-action').append('<div><p>None yet</p></div>');
                }
                else{
            ...
            else{$('#individual-event-to-deregister-message').css("color","#ff5c5c"); if(data['logout']) loaction.reload(); }
        },
        error:function(error){
            $('#individual-event-to-deregister-message').html("Not Connected to the Internet");
            $('#individual-event-to-deregister-message').css('display','block');
            $('#individual-event-to-deregister-message').css("color","#ff5c5c");
        }
    });
});
$('.accept-button').on('click',function(){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            else{$('#team-request-'+teamID+'-message').css("color","#ff5c5c"); if(data['logout']) loaction.reload(); }
        },
        error:function(error){
            console.log(error);
        }
