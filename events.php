...
<section style="margin-top:70px;">
    <div id="about_us" style="margin-bottom:0">
        <div data-aos="fade-down" data-aos-anchor-placement="top-center"><h1 class="friday" style="animation:unset;">it's &nbsp;not &nbsp;what &nbsp;you &nbsp;say,<br> &nbsp;but &nbsp;what &nbsp;you &nbsp;do.</h1><br></div>
</section>
<br>
<?php
...
<section style="width:88%;margin:20px auto 0;padding:20px">
  <h1 style="text-align:center;"><span class="nightmare">Event Categories</span></h1>
  <div class="flex">
<?php
  ...
  <a href="events?event_class=<?php echo $eventClass['event_class'];?>"><div class="event-class">
    ...
    <div class="celeb-name" style="text-align:center"><h3 class="nightmare"><?php echo $eventClass['event_class_name'];?></h3></div>
...
?>
<section style="width:88%;margin:20px auto 0;padding:20px">
  <h1 style="text-align:center;"><span class="nightmare">Events</span></h1>
  <br><br>
  ...
  <div data-aos="fade-down" data-aos-anchor-placement="center-bottom" class="event" style="position:relative;z-index:<?php $index = count($events)-$key; echo $index; ?>">
    <div class="flex">
      ...
      <div class="event-details">
        <p class="nightmare tag"><?php echo $eventClass['event_class_name'].' - '.$eventClass['event_class_details'].(($event['eventtype'] == 'team')?' Team':'').' Event';?></p>
        <h3 class="nightmare heading"><?php echo $event['event_name'];?></h3>
