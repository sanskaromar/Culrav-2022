...
<div id="logo-compliment">
    <h3 class="sm-show" style="margin:0;font-size:4vw;display:none;">2nd - 5th April, 2021</h3>
...
<section class="quote-section" data-aos="fade" data-aos-anchor-placement="top-center">
    ...
    <div class="content"><h3>healing through art</h3><h4>- Culrav</h4></div>
</section>
...
<section id="about-culrav">
    ...
    <div class="flex display-style-3" style="margin-bottom:0">
        <div class="count" style="transform:translateY(-40%); transform:translateX(-150%)">
        ...
        <div class="count" style="transform:translateY(40%); transform:translateX(130%)">
            <div class="heading" data-aos="fade-down" data-aos-anchor-placement="bottom-bottom">
                <h3>Kavyasandhya</h3>
