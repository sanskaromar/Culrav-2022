...
<section style="margin-top:70px;">
    <div id="about_us" style="margin-bottom:0">
        <div data-aos="fade-down" data-aos-anchor-placement="top-center"><h1 class="friday" style="animation:unset;color:#e02c2c">Beat &nbsp;your &nbsp;best<br>And &nbsp;keep &nbsp;doing &nbsp;that</h1><p class="nightmare">Don't hesitate to contact us, if you get stuck.<br>We're always there for you.</p></div>
</section>
<style>
.form{
