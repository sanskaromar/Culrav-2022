    ...
    <div class="flex">
        <div class="container-right">
            ...
            <div>
                ...
                <p class="simple">
                    <ul>
                        <li>Read all the rules about the events and how to submit the entries on the events page carefully before submission.</li>
                        <li>Provide the link of the folder on their drive (Name of the folder should have the <em>Name of the Participant_(Registration No)_Culrav</em> mentioned in it. For example- <em>FaresManzarKhan_(201xxxxx)_Culrav</em>. This folder will contain all the files related to the event.</li> 
                ...
                if($misc->isUserParticipating($user['username'],$eventID)){ ?>
                    ...
                    ?>
                        ...
                        <div class="form-field">
                            <label class="nightmare">Drive Shareable Link</label>
