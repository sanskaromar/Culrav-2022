...
<section class="form" style="margin:25px auto">
  <div class="form-field">
    <label class="nightmare">Username</label>
  ...
  <div class="form-field">
    <label class="nightmare">Password</label>
    <input name="password" type="password" required>
    <p id="password-check-message" class="error"></p>
  </div>
  <div class="form-field">
    <label class="nightmare">Undertaking</label>
    <ul>
    ...
    <div style="margin-bottom:0px;"><input type="checkbox" name="coc" required><label class="nightmare">I have read the undertaking and agree to the conditions and will be responsible for my actions.</label></div>
  </div>
  <div class="form-field">
    <label class="nightmare">ID Card (Provide as Google Drive Link)</label>
    <input name="idcard" type="text" required>
    <p id="password-check-message" class="error"></p>
  </div>
  <!-- <div style="margin-bottom:20px;"><input type="checkbox" name="coc" required><label class="nightmare">I have read the undertaking and agree to the conditions and will be responsible for my actions.</label></div> -->
